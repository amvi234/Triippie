...
import com.example.triippie.model.Kashmir
import kotlinx.android.synthetic.main.item_trip.view.*


class KashmirTripActivity:AppCompatActivity() {
    private lateinit var place:TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_trip_plan)
        place=findViewById(R.id.place)
        place.text="Places to Visit in Kashmir"
        val dataset= Kashmir().loadSpots()
